...
const reflection_cards = [
    ...
    {id: 7, "topic": "someone I'd love to hang out with"},
    {id: 8, "topic":  "a habit that has really paid off"}, 
    {id: 9, "topic": "is there anything you want to cut down on next year?"}, 
    {id: 10, "topic": "something you're looking forward to"},   
    {id: 11, "topic": "something you should put on the back burner"}, 
    {id: 13, "topic": "do you like to make plans, or do you prefer to play it by ear?"},
    ...
    {id: 21, "topic": "the best advice you received (or gave) this year"},
    {id: 22, "topic": "the highlight of my year in 2023"},
    {id: 23, "topic": "did your degree prepare you well for your career?"},
    {id: 24, "topic": "I would freak out if I saw....."},
  ]
