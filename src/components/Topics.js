...
const TopicCard = ({ topiccard }) => {
 ...
 const topic_cards = [
  {"id": 1, "topic": "is being an influencer a real job?"},  
  {"id": 2, "topic": "how I use AI"}, 
  {"id": 3, "topic": "a TV series I really enjoyed"}, 
  ...
  {"id": 8, "topic": "a place everyone should visit"},
  {"id": 9, "topic": "Dolly Parton"},
  {"id": 11, "topic": "immigration"},
  {"id": 12, "topic": "social media"},
  {"id": 13, "topic": "my dream house"},
  {"id": 14, "topic": "Elon Musk"},
